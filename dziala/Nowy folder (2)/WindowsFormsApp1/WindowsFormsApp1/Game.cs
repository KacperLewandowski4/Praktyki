...
namespace WindowsFormsApp1
{
    class Game
    {
        ...
        public Game(string playerName, IEnumerable<string> oponentNames, TextBox textBoxOnForm)
        {
        ...
        public bool PlayOneRound(int selectedPlayerCard)
        {
            ...
            for(int i = 0; i < players.Count; i++)
            {
                ...
                if(stock.Count == 0)
                {
                    textBoxOnForm.Text = "Na stole nie ma żadnych kart. GAME OVER!" + Environment.NewLine;
                    return true;
                }
            }
            return false;
       ...
       public string DescribePlayerHands()
        {
            ...
            description += "Na stole zostało: " + stock.Count + Environment.NewLine;
            return description;
        }
    }
}
